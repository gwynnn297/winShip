...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const data = {
    ...
    datasets: [{
      label: 'Doanh thu gồm thuế',
      data: [
        0.1, 0.2, 0.1, 0.3, 0.2, 0.4, 0.6, 0.8, 0.7, 0.8, 0.7, 0.9, 
        0.8, 0.9, 1, 0.9, 0.8, 0.9, 0.7, 0.5, 0.3, 0.3, 0.4, 0.2
...
const revenueData = [
  20, 12, 21, 18, 15, 22, 25, 30, 25, 20, 32, 28, 34, 27, 40, 35, 42, 33, 45, 38,
  40, 43, 48, 41, 53, 46, 55, 47, 50, 52, 42
];
